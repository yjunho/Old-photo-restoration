...
# For DIV2K
__C.DIR.DATASET_ROOT = '/root/IGNN-master/'
if cfg.DATASET.DATASET_TRAIN_NAME == 'DIV2K':
    __C.DIR.DATASET_JSON_TRAIN_PATH     = './datasets/json_files/DIV2K.json'
    __C.DIR.IMAGE_LR_TRAIN_PATH         = __C.DIR.DATASET_ROOT + 'DIV2K/DIV2K_{0}_LR_bicubic_sub/'+__C.DIR.DATASET_SCALE+'/{1}.png'
    __C.DIR.IMAGE_HR_TRAIN_PATH         = __C.DIR.DATASET_ROOT + 'DIV2K/DIV2K_{0}_HR_sub/{1}.png'
...
if cfg.DATASET.DATASET_TRAIN_NAME == 'f1':
    __C.DIR.DATASET_JSON_TRAIN_PATH     = './datasets/json_files/f1.json'
    __C.DIR.IMAGE_LR_TRAIN_PATH         = __C.DIR.DATASET_ROOT + 'f1_{0}_LR_bicubic_sub/'+__C.DIR.DATASET_SCALE+'/{1}.png'
    __C.DIR.IMAGE_HR_TRAIN_PATH         = __C.DIR.DATASET_ROOT + 'f1_{0}_HR_sub/{1}.png'    
